...
class Ui_Preferences(object):
    def setupUi(self, Preferences: QDialog) -> None:
        ...
        self.verticalLayout_3 = QVBoxLayout(self.tab_ui)
        ...
        self.groupBox = QGroupBox(self.tab_ui)
        ...
        self.comboBoxDoubleClickAction = QComboBox(self.groupBox)
        ...
        sizePolicy.setHeightForWidth(self.comboBoxDoubleClickAction.sizePolicy().hasHeightForWidth())
        self.comboBoxDoubleClickAction.setSizePolicy(sizePolicy)
        self.comboBoxDoubleClickAction.setFont(font1)

        self.horizontalLayout_3.addWidget(self.comboBoxDoubleClickAction)
        ...
        sizePolicy2.setHeightForWidth(self.pushButtonColorBranch.sizePolicy().hasHeightForWidth())
        self.pushButtonColorBranch.setSizePolicy(sizePolicy2)

        self.gridLayout_3.addWidget(self.pushButtonColorBranch, 0, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.pushButtonColorTag, 1, 1, 1, 1)
        ...
        sizePolicy1.setHeightForWidth(self.groupBoxSublimemerge.sizePolicy().hasHeightForWidth())
        self.groupBoxSublimemerge.setSizePolicy(sizePolicy1)
        ...
        sizePolicy4.setHeightForWidth(self.radioSublimemergeAutoDetect.sizePolicy().hasHeightForWidth())
        self.radioSublimemergeAutoDetect.setSizePolicy(sizePolicy4)
        ...
        sizePolicy5.setHeightForWidth(self.lineEditSublimemergeAutoDetect.sizePolicy().hasHeightForWidth())
        self.lineEditSublimemergeAutoDetect.setSizePolicy(sizePolicy5)
        ...
        sizePolicy4.setHeightForWidth(self.radioSublimemergeManual.sizePolicy().hasHeightForWidth())
        self.radioSublimemergeManual.setSizePolicy(sizePolicy4)
        ...
        sizePolicy6.setHeightForWidth(self.lineEditSublimemergeManual.sizePolicy().hasHeightForWidth())
        self.lineEditSublimemergeManual.setSizePolicy(sizePolicy6)
        ...
        sizePolicy7.setHeightForWidth(self.pushButtonSublimemergeManualBrowse.sizePolicy().hasHeightForWidth())
        self.pushButtonSublimemergeManualBrowse.setSizePolicy(sizePolicy7)
        ...
        sizePolicy1.setHeightForWidth(self.groupBoxGitGui.sizePolicy().hasHeightForWidth())
        self.groupBoxGitGui.setSizePolicy(sizePolicy1)
        ...
        sizePolicy6.setHeightForWidth(self.lineEditGitGuiManual.sizePolicy().hasHeightForWidth())
        self.lineEditGitGuiManual.setSizePolicy(sizePolicy6)
        ...
        self.labelExecGitGuiChoose = QLabel(self.groupBoxGitGui)
        self.labelExecGitGuiChoose.setObjectName(u"labelExecGitGuiChoose")
        self.labelExecGitGuiChoose.setFont(font1)

        self.gridLayout_9.addWidget(self.labelExecGitGuiChoose, 2, 0, 1, 2)
        ...
        sizePolicy5.setHeightForWidth(self.lineEditGitGuiAutoDetect.sizePolicy().hasHeightForWidth())
        self.lineEditGitGuiAutoDetect.setSizePolicy(sizePolicy5)
        ...
        sizePolicy1.setHeightForWidth(self.groupBoxGitK.sizePolicy().hasHeightForWidth())
        self.groupBoxGitK.setSizePolicy(sizePolicy1)
        ...
        sizePolicy7.setHeightForWidth(self.pushButtonGitKManualBrowse.sizePolicy().hasHeightForWidth())
        self.pushButtonGitKManualBrowse.setSizePolicy(sizePolicy7)
        ...
        sizePolicy6.setHeightForWidth(self.lineEditGitKManual.sizePolicy().hasHeightForWidth())
        self.lineEditGitKManual.setSizePolicy(sizePolicy6)
        ...
        sizePolicy5.setHeightForWidth(self.lineEditGitKAutoDetect.sizePolicy().hasHeightForWidth())
        self.lineEditGitKAutoDetect.setSizePolicy(sizePolicy5)
        ...
        sizePolicy1.setHeightForWidth(self.groupBoxTGit.sizePolicy().hasHeightForWidth())
        self.groupBoxTGit.setSizePolicy(sizePolicy1)
        ...
        self.labelExecTGitChoose = QLabel(self.groupBoxTGit)
        self.labelExecTGitChoose.setObjectName(u"labelExecTGitChoose")
        self.labelExecTGitChoose.setFont(font1)

        self.gridLayout_2.addWidget(self.labelExecTGitChoose, 2, 0, 1, 3)
        ...
        sizePolicy7.setHeightForWidth(self.pushButtonTGitManualBrowse.sizePolicy().hasHeightForWidth())
        self.pushButtonTGitManualBrowse.setSizePolicy(sizePolicy7)
        ...
        sizePolicy1.setHeightForWidth(self.groupBoxExplorer.sizePolicy().hasHeightForWidth())
        self.groupBoxExplorer.setSizePolicy(sizePolicy1)
        ...
        self.labelExecExplorerChoose = QLabel(self.groupBoxExplorer)
        self.labelExecExplorerChoose.setObjectName(u"labelExecExplorerChoose")
        sizePolicy8 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Fixed)
        sizePolicy8.setHorizontalStretch(0)
        sizePolicy8.setVerticalStretch(0)
        sizePolicy8.setHeightForWidth(self.labelExecExplorerChoose.sizePolicy().hasHeightForWidth())
        self.labelExecExplorerChoose.setSizePolicy(sizePolicy8)
        self.labelExecExplorerChoose.setFont(font1)

        self.gridLayout_5.addWidget(self.labelExecExplorerChoose, 0, 0, 1, 3)
        ...
        sizePolicy4.setHeightForWidth(self.radioExplorerAutoDetect.sizePolicy().hasHeightForWidth())
        self.radioExplorerAutoDetect.setSizePolicy(sizePolicy4)
        ...
        sizePolicy5.setHeightForWidth(self.lineEditExplorerAutoDetect.sizePolicy().hasHeightForWidth())
        self.lineEditExplorerAutoDetect.setSizePolicy(sizePolicy5)
        ...
        sizePolicy4.setHeightForWidth(self.radioExplorerManual.sizePolicy().hasHeightForWidth())
        self.radioExplorerManual.setSizePolicy(sizePolicy4)
        ...
        sizePolicy6.setHeightForWidth(self.lineEditExplorerManual.sizePolicy().hasHeightForWidth())
        self.lineEditExplorerManual.setSizePolicy(sizePolicy6)
        ...
        sizePolicy7.setHeightForWidth(self.pushButtonExplorerManualBrowse.sizePolicy().hasHeightForWidth())
        self.pushButtonExplorerManualBrowse.setSizePolicy(sizePolicy7)
        ...
        sizePolicy1.setHeightForWidth(self.groupBoxGitBash.sizePolicy().hasHeightForWidth())
        self.groupBoxGitBash.setSizePolicy(sizePolicy1)
        ...
        sizePolicy5.setHeightForWidth(self.lineEditGitBashAutoDetect.sizePolicy().hasHeightForWidth())
        self.lineEditGitBashAutoDetect.setSizePolicy(sizePolicy5)
        ...
        sizePolicy4.setHeightForWidth(self.radioGitBashManual.sizePolicy().hasHeightForWidth())
        self.radioGitBashManual.setSizePolicy(sizePolicy4)
        ...
        self.lineEditGitBashManual.setSizePolicy(sizePolicy6)
        ...
        sizePolicy4.setHeightForWidth(self.radioGitBashAutoDetect.sizePolicy().hasHeightForWidth())
        self.radioGitBashAutoDetect.setSizePolicy(sizePolicy4)
        self.radioGitBashAutoDetect.setFont(font1)

        self.gridLayout_6.addWidget(self.radioGitBashAutoDetect, 3, 0, 1, 1)

        self.labelExecGitBashChoose = QLabel(self.groupBoxGitBash)
        self.labelExecGitBashChoose.setObjectName(u"labelExecGitBashChoose")
        self.labelExecGitBashChoose.setFont(font1)

        self.gridLayout_6.addWidget(self.labelExecGitBashChoose, 2, 0, 1, 2)
        ...
        self.radioGitManual.setSizePolicy(sizePolicy4)
        ...
        self.lineEditGitManual.setSizePolicy(sizePolicy6)
        ...
        sizePolicy6.setHeightForWidth(self.lineEditGitAutoDetect.sizePolicy().hasHeightForWidth())
        self.lineEditGitAutoDetect.setSizePolicy(sizePolicy6)
        ...
        sizePolicy1.setHeightForWidth(self.groupBoxSourcetree.sizePolicy().hasHeightForWidth())
        self.groupBoxSourcetree.setSizePolicy(sizePolicy1)
        ...
        sizePolicy4.setHeightForWidth(self.radioSourcetreeAutoDetect.sizePolicy().hasHeightForWidth())
        self.radioSourcetreeAutoDetect.setSizePolicy(sizePolicy4)
        ...
        sizePolicy5.setHeightForWidth(self.lineEditSourcetreeAutoDetect.sizePolicy().hasHeightForWidth())
        self.lineEditSourcetreeAutoDetect.setSizePolicy(sizePolicy5)
        ...
        self.labelExecSourcetreeChoose = QLabel(self.groupBoxSourcetree)
        self.labelExecSourcetreeChoose.setObjectName(u"labelExecSourcetreeChoose")
        self.labelExecSourcetreeChoose.setFont(font1)

        self.gridLayout_8.addWidget(self.labelExecSourcetreeChoose, 2, 0, 1, 3)
        ...
        sizePolicy7.setHeightForWidth(self.pushButtonSourcetreeManualBrowse.sizePolicy().hasHeightForWidth())
        self.pushButtonSourcetreeManualBrowse.setSizePolicy(sizePolicy7)
        ...
        self.labelExecGitGuiChoose.setBuddy(self.radioGitGuiAutoDetect)
        self.labelExecGitkChoose.setBuddy(self.radioGitKAutoDetect)
        self.labelExecTGitChoose.setBuddy(self.radioTGitAutoDetect)
        self.labelExecExplorerChoose.setBuddy(self.radioExplorerAutoDetect)
        self.labelExecGitBashChoose.setBuddy(self.radioGitBashAutoDetect)
        self.labelExecGitChoose.setBuddy(self.radioGitAutoDetect)
        self.labelExecSourcetreeChoose.setBuddy(self.radioSourcetreeAutoDetect)
#endif // QT_CONFIG(shortcut)
        QWidget.setTabOrder(self.checkBoxFetchOnStartup, self.comboBoxDoubleClickAction)
        ...
        QWidget.setTabOrder(self.comboUpdateFrequency, self.checkBoxConfirmWhenQuitting)
        QWidget.setTabOrder(self.checkBoxConfirmWhenQuitting, self.radioGitAutoDetect)
        ...
        QWidget.setTabOrder(self.pushButtonGitManualBrowse, self.radioExplorerAutoDetect)
        ...
        QWidget.setTabOrder(self.lineEditExplorerFlatpak, self.checkBoxGitGui)
        ...
        QWidget.setTabOrder(self.pushButtonGitKManualBrowse, self.checkBoxSublimeMerge)
        ...
        QWidget.setTabOrder(self.pushButtonSublimemergeManualBrowse, self.radioSublimemergeFlatpak)
        QWidget.setTabOrder(self.radioSublimemergeFlatpak, self.lineEditSublimemergeFlatpak)
        QWidget.setTabOrder(self.lineEditSublimemergeFlatpak, self.radioSublimemergeSnap)
        QWidget.setTabOrder(self.radioSublimemergeSnap, self.lineEditSublimemergeSnap)
        QWidget.setTabOrder(self.lineEditSublimemergeSnap, self.checkBoxTortoiseGit)
        ...
        QWidget.setTabOrder(self.pushButtonSourcetreeManualBrowse, self.checkBoxGitBash)
        ...
        QWidget.setTabOrder(self.pushButtonGitBashManualBrowse, self.tabWidget)
        ...
        self.checkBoxSourcetree.toggled.connect(self.labelExecSourcetreeChoose.setEnabled)
        ...
        self.checkBoxTortoiseGit.toggled.connect(self.labelExecTGitChoose.setEnabled)
        ...
        self.checkBoxGitBash.toggled.connect(self.labelExecGitBashChoose.setEnabled)
    ...
    def retranslateUi(self, Preferences: QDialog) -> None:
        ...
        self.groupBox.setTitle(QCoreApplication.translate("Preferences", u"Double-click action", None))
        ...
        self.labelExecGitGuiChoose.setText(QCoreApplication.translate("Preferences", u"Choose git-gui executable location :", None))
        ...
        self.labelExecTGitChoose.setText(QCoreApplication.translate("Preferences", u"Choose TortoiseGitProc.exe executable location :", None))
        ...
        self.labelExecExplorerChoose.setText(QCoreApplication.translate("Preferences", u"Choose File Explorer program to open directories :", None))
        ...
        self.labelExecGitBashChoose.setText(QCoreApplication.translate("Preferences", u"Choose git-bash.exe executable location :", None))
        ...
        self.labelExecSourcetreeChoose.setText(QCoreApplication.translate("Preferences", u"Choose SourceTree.exe executable location :", None))
