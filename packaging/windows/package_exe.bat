...
pyinstaller.exe -y packaging\windows\multigit.spec || exit /b 1
pyinstaller.exe -y packaging\windows\mgitcmd.spec || exit /b 1
...
pyi-set_version packaging\windows\multigit_version_info.txt dist\MultiGit\MultiGit.exe
pyi-set_version packaging\windows\multigit_version_info.txt dist\MultiGit\mgitcmd.exe
